...
const Payment = () => {
  ...
  const validateForm = (): boolean => {
    const { fullName, email, phone, address, city, state, zipCode } = shippingDetails;
              ...
              <div className="neo-blur backdrop-blur-sm rounded-lg border border-white/10 p-6">
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center">
                      <div className={`w-5 h-5 rounded-full border mr-3 flex items-center justify-center ${
                        paymentMethod === 'card' ? 'border-litvi-purple' : 'border-white/30'
                      }`}>
                        {paymentMethod === 'card' && (
                  ...
                  >
                    <div className="flex items-center">
                      <div className={`w-5 h-5 rounded-full border mr-3 flex items-center justify-center ${
                        paymentMethod === 'cod' ? 'border-litvi-purple' : 'border-white/30'
                      }`}>
                        {paymentMethod === 'cod' && (
                          <div className="w-3 h-3 rounded-full bg-litvi-purple"></div>
                        )}

...
const VerifyOtp = () => {
  ...
  const handleResendOtp = () => {
    // In a real application, you would call the API to resend the OTP
    toast({
      title: "Info",
  ...
  return (
    <div className="min-h-screen bg-litvi-dark flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 text-center">
          <Link to="/auth/login" className="text-litvi-purple hover:text-litvi-magenta text-sm font-medium">
            Back to login
          </Link>
        </div>
      </div>
